...
*/
    ...
    */
    ...
    public void ttt(HttpServletResponse response) throws Exception{
        response.setContentType("application/json;charset=utf-8");
        String json = Result.build(ResultType.Success).appendData("sid",semesterService.getThisTimeSemesterId()).convertIntoJSON();
        response.getWriter().write(json);
    }
